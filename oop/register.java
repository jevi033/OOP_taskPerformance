...
public class register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to MCville Restaurant!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField2.getText().length()<=0 || jTextField3.getText().length()<=0){
            if (jTextField4.getText().length()<=0 || jTextField1.getText().length()<=0){
                JOptionPane.showMessageDialog(null,"Kindly fill up all information");
            }
        } else {
